...
//  source: /Users/marcussmith/HambroPerks/laundrapp_org/cucumber-jvm/core/src/main/java/cucumber/api/Delimiter.java
//
...
- (NSString *)description {
  return [NSString stringWithFormat:@"@cucumber.api.Delimiter(value=%@)", value_];
}
