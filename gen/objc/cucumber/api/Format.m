...
//  source: /Users/Salton/Documents/Projects/cucumber-jvm/core/src/main/java/cucumber/api/Format.java
//
...
- (NSString *)description {
  return [NSString stringWithFormat:@"@cucumber.api.Format(value=%@)", value_];
}
