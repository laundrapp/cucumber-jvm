...
__attribute__((unused)) static IOSObjectArray *CCBDar__Annotations$0(void);

@implementation CCBDar
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBDar__Annotations$0 };
  static const J2ObjcClassInfo _CCBDar = { "Dar", "cucumber.api.java.ro", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBDar;
}

@end

id<CCBDar> create_CCBDar(jlong timeout, NSString *value) {
  CCBDar *self = AUTORELEASE([[CCBDar alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBDar__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBDar)
