...
__attribute__((unused)) static IOSObjectArray *CCBDațifiind__Annotations$0(void);

@implementation CCBDațifiind
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBDațifiind__Annotations$0 };
  static const J2ObjcClassInfo _CCBDațifiind = { "Dațifiind", "cucumber.api.java.ro", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBDațifiind;
}

@end

id<CCBDațifiind> create_CCBDațifiind(jlong timeout, NSString *value) {
  CCBDațifiind *self = AUTORELEASE([[CCBDațifiind alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBDațifiind__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBDațifiind)
