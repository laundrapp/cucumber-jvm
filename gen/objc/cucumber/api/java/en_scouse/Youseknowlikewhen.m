...
#include "cucumber/api/java/en_scouse/Youseknowlikewhen.h"
...
- (NSString *)description {
  return [NSString stringWithFormat:@"@cucumber.api.java.en_scouse.Youseknowlikewhen(value=%@, timeout=%lld)", value_, timeout_];
}
