...
__attribute__((unused)) static IOSObjectArray *CCBԵվ__Annotations$0(void);

@implementation CCBԵվ
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBԵվ__Annotations$0 };
  static const J2ObjcClassInfo _CCBԵվ = { "Եվ", "cucumber.api.java.am", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBԵվ;
}

@end

id<CCBԵվ> create_CCBԵվ(jlong timeout, NSString *value) {
  CCBԵվ *self = AUTORELEASE([[CCBԵվ alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBԵվ__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBԵվ)
