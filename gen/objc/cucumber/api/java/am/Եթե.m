...
__attribute__((unused)) static IOSObjectArray *CCBԵթե__Annotations$0(void);

@implementation CCBԵթե
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBԵթե__Annotations$0 };
  static const J2ObjcClassInfo _CCBԵթե = { "Եթե", "cucumber.api.java.am", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBԵթե;
}

@end

id<CCBԵթե> create_CCBԵթե(jlong timeout, NSString *value) {
  CCBԵթե *self = AUTORELEASE([[CCBԵթե alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBԵթե__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBԵթե)
