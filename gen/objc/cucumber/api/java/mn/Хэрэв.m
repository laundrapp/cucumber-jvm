...
__attribute__((unused)) static IOSObjectArray *CCBХэрэв__Annotations$0(void);

@implementation CCBХэрэв
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBХэрэв__Annotations$0 };
  static const J2ObjcClassInfo _CCBХэрэв = { "Хэрэв", "cucumber.api.java.mn", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBХэрэв;
}

@end

id<CCBХэрэв> create_CCBХэрэв(jlong timeout, NSString *value) {
  CCBХэрэв *self = AUTORELEASE([[CCBХэрэв alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBХэрэв__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBХэрэв)
