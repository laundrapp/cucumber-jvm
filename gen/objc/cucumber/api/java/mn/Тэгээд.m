...
__attribute__((unused)) static IOSObjectArray *CCBТэгээд__Annotations$0(void);

@implementation CCBТэгээд
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBТэгээд__Annotations$0 };
  static const J2ObjcClassInfo _CCBТэгээд = { "Тэгээд", "cucumber.api.java.mn", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBТэгээд;
}

@end

id<CCBТэгээд> create_CCBТэгээд(jlong timeout, NSString *value) {
  CCBТэгээд *self = AUTORELEASE([[CCBТэгээд alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBТэгээд__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBТэгээд)
