...
__attribute__((unused)) static IOSObjectArray *CCBYknow__Annotations$0(void);

@implementation CCBYknow
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBYknow__Annotations$0 };
  static const J2ObjcClassInfo _CCBYknow = { "Yknow", "cucumber.api.java.en_au", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBYknow;
}

@end

id<CCBYknow> create_CCBYknow(jlong timeout, NSString *value) {
  CCBYknow *self = AUTORELEASE([[CCBYknow alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBYknow__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBYknow)
