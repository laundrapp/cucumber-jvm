...
__attribute__((unused)) static IOSObjectArray *CCBÞa__Annotations$0(void);

@implementation CCBÞa
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBÞa__Annotations$0 };
  static const J2ObjcClassInfo _CCBÞa = { "Þa", "cucumber.api.java.en_old", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBÞa;
}

@end

id<CCBÞa> create_CCBÞa(jlong timeout, NSString *value) {
  CCBÞa *self = AUTORELEASE([[CCBÞa alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBÞa__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBÞa)
