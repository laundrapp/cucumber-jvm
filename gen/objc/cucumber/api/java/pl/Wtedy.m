...
__attribute__((unused)) static IOSObjectArray *CCBWtedy__Annotations$0(void);

@implementation CCBWtedy
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBWtedy__Annotations$0 };
  static const J2ObjcClassInfo _CCBWtedy = { "Wtedy", "cucumber.api.java.pl", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBWtedy;
}

@end

id<CCBWtedy> create_CCBWtedy(jlong timeout, NSString *value) {
  CCBWtedy *self = AUTORELEASE([[CCBWtedy alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBWtedy__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBWtedy)
