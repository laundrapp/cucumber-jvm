...
__attribute__((unused)) static IOSObjectArray *CCBただし__Annotations$0(void);

@implementation CCBただし
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBただし__Annotations$0 };
  static const J2ObjcClassInfo _CCBただし = { "ただし", "cucumber.api.java.ja", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBただし;
}

@end

id<CCBただし> create_CCBただし(jlong timeout, NSString *value) {
  CCBただし *self = AUTORELEASE([[CCBただし alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBただし__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBただし)
