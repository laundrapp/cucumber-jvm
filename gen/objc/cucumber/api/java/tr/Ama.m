...
__attribute__((unused)) static IOSObjectArray *CCBAma__Annotations$0(void);

@implementation CCBAma
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBAma__Annotations$0 };
  static const J2ObjcClassInfo _CCBAma = { "Ama", "cucumber.api.java.tr", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBAma;
}

@end

id<CCBAma> create_CCBAma(jlong timeout, NSString *value) {
  CCBAma *self = AUTORELEASE([[CCBAma alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBAma__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBAma)
