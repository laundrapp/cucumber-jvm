...
__attribute__((unused)) static IOSObjectArray *CCBEntón__Annotations$0(void);

@implementation CCBEntón
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBEntón__Annotations$0 };
  static const J2ObjcClassInfo _CCBEntón = { "Entón", "cucumber.api.java.gl", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBEntón;
}

@end

id<CCBEntón> create_CCBEntón(jlong timeout, NSString *value) {
  CCBEntón *self = AUTORELEASE([[CCBEntón alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBEntón__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBEntón)
