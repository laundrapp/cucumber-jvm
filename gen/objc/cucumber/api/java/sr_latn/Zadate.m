...
__attribute__((unused)) static IOSObjectArray *CCBZadate__Annotations$0(void);

@implementation CCBZadate
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBZadate__Annotations$0 };
  static const J2ObjcClassInfo _CCBZadate = { "Zadate", "cucumber.api.java.sr_latn", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBZadate;
}

@end

id<CCBZadate> create_CCBZadate(jlong timeout, NSString *value) {
  CCBZadate *self = AUTORELEASE([[CCBZadate alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBZadate__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBZadate)
