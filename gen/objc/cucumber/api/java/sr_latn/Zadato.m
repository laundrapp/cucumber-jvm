...
__attribute__((unused)) static IOSObjectArray *CCBZadato__Annotations$0(void);

@implementation CCBZadato
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBZadato__Annotations$0 };
  static const J2ObjcClassInfo _CCBZadato = { "Zadato", "cucumber.api.java.sr_latn", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBZadato;
}

@end

id<CCBZadato> create_CCBZadato(jlong timeout, NSString *value) {
  CCBZadato *self = AUTORELEASE([[CCBZadato alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBZadato__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBZadato)
