...
__attribute__((unused)) static IOSObjectArray *CCBQuan__Annotations$0(void);

@implementation CCBQuan
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBQuan__Annotations$0 };
  static const J2ObjcClassInfo _CCBQuan = { "Quan", "cucumber.api.java.ca", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBQuan;
}

@end

id<CCBQuan> create_CCBQuan(jlong timeout, NSString *value) {
  CCBQuan *self = AUTORELEASE([[CCBQuan alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBQuan__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBQuan)
