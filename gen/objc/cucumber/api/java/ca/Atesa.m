...
__attribute__((unused)) static IOSObjectArray *CCBAtesa__Annotations$0(void);

@implementation CCBAtesa
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBAtesa__Annotations$0 };
  static const J2ObjcClassInfo _CCBAtesa = { "Atesa", "cucumber.api.java.ca", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBAtesa;
}

@end

id<CCBAtesa> create_CCBAtesa(jlong timeout, NSString *value) {
  CCBAtesa *self = AUTORELEASE([[CCBAtesa alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBAtesa__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBAtesa)
