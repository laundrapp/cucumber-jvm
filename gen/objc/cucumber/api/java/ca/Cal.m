...
__attribute__((unused)) static IOSObjectArray *CCBCal__Annotations$0(void);

@implementation CCBCal
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBCal__Annotations$0 };
  static const J2ObjcClassInfo _CCBCal = { "Cal", "cucumber.api.java.ca", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBCal;
}

@end

id<CCBCal> create_CCBCal(jlong timeout, NSString *value) {
  CCBCal *self = AUTORELEASE([[CCBCal alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBCal__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBCal)
