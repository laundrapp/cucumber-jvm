...
__attribute__((unused)) static IOSObjectArray *CCBDaes__Annotations$0(void);

@implementation CCBDaes
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBDaes__Annotations$0 };
  static const J2ObjcClassInfo _CCBDaes = { "Daes", "cucumber.api.java.ast", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBDaes;
}

@end

id<CCBDaes> create_CCBDaes(jlong timeout, NSString *value) {
  CCBDaes *self = AUTORELEASE([[CCBDaes alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBDaes__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBDaes)
