...
__attribute__((unused)) static IOSObjectArray *CCBSed__Annotations$0(void);

@implementation CCBSed
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBSed__Annotations$0 };
  static const J2ObjcClassInfo _CCBSed = { "Sed", "cucumber.api.java.eo", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBSed;
}

@end

id<CCBSed> create_CCBSed(jlong timeout, NSString *value) {
  CCBSed *self = AUTORELEASE([[CCBSed alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBSed__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBSed)
