...
__attribute__((unused)) static IOSObjectArray *CCBEntao__Annotations$0(void);

@implementation CCBEntao
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBEntao__Annotations$0 };
  static const J2ObjcClassInfo _CCBEntao = { "Entao", "cucumber.api.java.pt", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBEntao;
}

@end

id<CCBEntao> create_CCBEntao(jlong timeout, NSString *value) {
  CCBEntao *self = AUTORELEASE([[CCBEntao alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBEntao__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBEntao)
