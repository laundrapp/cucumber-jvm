...
__attribute__((unused)) static IOSObjectArray *CCBअगर__Annotations$0(void);

@implementation CCBअगर
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBअगर__Annotations$0 };
  static const J2ObjcClassInfo _CCBअगर = { "अगर", "cucumber.api.java.hi", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBअगर;
}

@end

id<CCBअगर> create_CCBअगर(jlong timeout, NSString *value) {
  CCBअगर *self = AUTORELEASE([[CCBअगर alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBअगर__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBअगर)
