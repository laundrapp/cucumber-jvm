...
__attribute__((unused)) static IOSObjectArray *CCBAmpak__Annotations$0(void);

@implementation CCBAmpak
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBAmpak__Annotations$0 };
  static const J2ObjcClassInfo _CCBAmpak = { "Ampak", "cucumber.api.java.sl", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBAmpak;
}

@end

id<CCBAmpak> create_CCBAmpak(jlong timeout, NSString *value) {
  CCBAmpak *self = AUTORELEASE([[CCBAmpak alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBAmpak__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBAmpak)
