...
__attribute__((unused)) static IOSObjectArray *CCBKo__Annotations$0(void);

@implementation CCBKo
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBKo__Annotations$0 };
  static const J2ObjcClassInfo _CCBKo = { "Ko", "cucumber.api.java.sl", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBKo;
}

@end

id<CCBKo> create_CCBKo(jlong timeout, NSString *value) {
  CCBKo *self = AUTORELEASE([[CCBKo alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBKo__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBKo)
