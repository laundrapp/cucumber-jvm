...
__attribute__((unused)) static IOSObjectArray *CCBӘмма__Annotations$0(void);

@implementation CCBӘмма
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { (void *)&CCBӘмма__Annotations$0 };
  static const J2ObjcClassInfo _CCBӘмма = { "Әмма", "cucumber.api.java.tt", ptrTable, methods, fields, 7, 0x2609, 2, 2, -1, -1, -1, -1, 0 };
  return &_CCBӘмма;
}

@end

id<CCBӘмма> create_CCBӘмма(jlong timeout, NSString *value) {
  CCBӘмма *self = AUTORELEASE([[CCBӘмма alloc] init]);
  self->timeout_ = timeout;
  self->value_ = RETAIN_(value);
  return self;
}

IOSObjectArray *CCBӘмма__Annotations$0() {
...
J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CCBӘмма)
