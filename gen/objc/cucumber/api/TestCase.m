...
- (void)runWithCCBEventBus:(CCBEventBus *)bus {
  ...
  for (CucumberApiTestStep * __strong step in nil_chk(testSteps_)) {
    CucumberApiResult *stepResult = [((CucumberApiTestStep *) nil_chk(step)) runWithCCBEventBus:bus withNSString:[((GherkinPicklesPickle *) nil_chk(((GherkinEventsPickleEvent *) nil_chk(pickleEvent_))->pickle_)) getLanguage] withCucumberApiScenario:scenarioResult withBoolean:skipNextStep];
