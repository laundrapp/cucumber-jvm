...
//  source: /Users/marcussmith/HambroPerks/laundrapp_org/cucumber-jvm/core/src/main/java/cucumber/runtime/io/URLOutputStream.java
//
...
J2OBJC_FIELD_SETTER(CucumberRuntimeIoURLOutputStream_ResponseException, gson_, GherkinDepsComGoogleGsonGson *)
...
- (NSString *)getMessage {
  if ([((NSString *) nil_chk(contentType_)) isEqual:@"application/json"]) {
    id<JavaUtilMap> map = [((GherkinDepsComGoogleGsonGson *) nil_chk(gson_)) fromJsonWithNSString:[super getMessage] withIOSClass:JavaUtilMap_class_()];
...
void CucumberRuntimeIoURLOutputStream_ResponseException_initWithCucumberRuntimeIoURLOutputStream_withNSString_withJavaIoIOException_withInt_withNSString_(CucumberRuntimeIoURLOutputStream_ResponseException *self, CucumberRuntimeIoURLOutputStream *outer$, NSString *responseBody, JavaIoIOException *cause, jint responseCode, NSString *contentType) {
  ...
  JreStrongAssignAndConsume(&self->gson_, new_GherkinDepsComGoogleGsonGson_init());
