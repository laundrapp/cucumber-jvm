...
inline GherkinDepsComGoogleGsonGson *CucumberRuntimeFormatterHTMLFormatter_get_gson(void);
static GherkinDepsComGoogleGsonGson *CucumberRuntimeFormatterHTMLFormatter_gson;
J2OBJC_STATIC_FIELD_OBJ_FINAL(CucumberRuntimeFormatterHTMLFormatter, gson, GherkinDepsComGoogleGsonGson *)
...
- (instancetype)initWithCucumberRuntimeFormatterHTMLFormatter:(CucumberRuntimeFormatterHTMLFormatter *)outer$;
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "gson", "LGherkinDepsComGoogleGsonGson;", .constantValue.asLong = 0, 0x1a, -1, 74, -1, -1 },
...
+ (void)initialize {
  if (self == [CucumberRuntimeFormatterHTMLFormatter class]) {
    JreStrongAssign(&CucumberRuntimeFormatterHTMLFormatter_gson, [((GherkinDepsComGoogleGsonGsonBuilder *) nil_chk([create_GherkinDepsComGoogleGsonGsonBuilder_init() setPrettyPrinting])) create]);
...
void CucumberRuntimeFormatterHTMLFormatter_jsFunctionCallWithNSString_withNSObjectArray_(CucumberRuntimeFormatterHTMLFormatter *self, NSString *functionName, IOSObjectArray *args) {
  ...
  jboolean comma = false;
  {
    ...
    while (b__ < e__) {
      ...
      NSString *stringArg = [((GherkinDepsComGoogleGsonGson *) nil_chk(CucumberRuntimeFormatterHTMLFormatter_gson)) toJsonWithId:arg];
