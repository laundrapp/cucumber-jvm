...
//  source: /Users/marcussmith/HambroPerks/laundrapp_org/cucumber-jvm/core/src/main/java/cucumber/runtime/autocomplete/MetaStepdef.java
//
...
inline GherkinDepsComGoogleGsonGson *CucumberRuntimeAutocompleteMetaStepdef_get_GSON(void);
static GherkinDepsComGoogleGsonGson *CucumberRuntimeAutocompleteMetaStepdef_GSON;
J2OBJC_STATIC_FIELD_OBJ_FINAL(CucumberRuntimeAutocompleteMetaStepdef, GSON, GherkinDepsComGoogleGsonGson *)
...
- (NSString *)description {
  return [((GherkinDepsComGoogleGsonGson *) nil_chk(CucumberRuntimeAutocompleteMetaStepdef_GSON)) toJsonWithId:self];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "GSON", "LGherkinDepsComGoogleGsonGson;", .constantValue.asLong = 0, 0x1a, -1, 6, -1, -1 },
...
+ (void)initialize {
  if (self == [CucumberRuntimeAutocompleteMetaStepdef class]) {
    JreStrongAssign(&CucumberRuntimeAutocompleteMetaStepdef_GSON, [create_GherkinDepsComGoogleGsonGsonBuilder_init() create]);
