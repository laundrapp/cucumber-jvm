...
J2OBJC_FIELD_SETTER(CCBRTableDiffException, from_, CucumberApiDataTable *)
J2OBJC_FIELD_SETTER(CCBRTableDiffException, to_, CucumberApiDataTable *)
J2OBJC_FIELD_SETTER(CCBRTableDiffException, diff_, CucumberApiDataTable *)
...
- (instancetype __nonnull)initWithCucumberApiDataTable:(CucumberApiDataTable *)from
  ...
  CCBRTableDiffException_initWithCucumberApiDataTable_withCucumberApiDataTable_withCucumberApiDataTable_(self, from, to, diff);
  return self;
}
...
void CCBRTableDiffException_initWithCucumberApiDataTable_withCucumberApiDataTable_withCucumberApiDataTable_(CCBRTableDiffException *self, CucumberApiDataTable *from, CucumberApiDataTable *to, CucumberApiDataTable *diff) {
...
CCBRTableDiffException *new_CCBRTableDiffException_initWithCucumberApiDataTable_withCucumberApiDataTable_withCucumberApiDataTable_(CucumberApiDataTable *from, CucumberApiDataTable *to, CucumberApiDataTable *diff) {
  J2OBJC_NEW_IMPL(CCBRTableDiffException, initWithCucumberApiDataTable_withCucumberApiDataTable_withCucumberApiDataTable_, from, to, diff)
}

CCBRTableDiffException *create_CCBRTableDiffException_initWithCucumberApiDataTable_withCucumberApiDataTable_withCucumberApiDataTable_(CucumberApiDataTable *from, CucumberApiDataTable *to, CucumberApiDataTable *diff) {
  J2OBJC_CREATE_IMPL(CCBRTableDiffException, initWithCucumberApiDataTable_withCucumberApiDataTable_withCucumberApiDataTable_, from, to, diff)
}
